...
public class Conventions {
    ...
    public static String deriveMappingForView(Class<?> beanClass) {
        if (beanClass.isAnnotationPresent(ViewComposition.class)) {
            ViewComposition annotation = beanClass.getAnnotation(ViewComposition.class);
            return annotation.name();
        }
        throw new IllegalArgumentException("View name is not properly defined in " + beanClass.getCanonicalName());
    }
